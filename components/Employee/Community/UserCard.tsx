...
const UserCard = ({
    ...
    return (
        <div className="border rounded-xl p-4 bg-white shadow-sm relative flex flex-col justify-between min-h-[400px]">
            ...
            <span
                className={` mb-3 text-[10px] font-[400] max-w-[100px] px-3 py-2 rounded-full bg-[#35CC6B2B] text-[#35CC6B] border-[0.6px] border-[#35CC6B] whitespace-nowrap text-center`}
            >
                {status}
            </span>
            {/* Description */}
            ...
            {/* Skills or Jobs */}
            <p className="text-[12px] font-medium mb-1">{isCompany ? 'Top Jobs' : 'Top Skill'}</p>
